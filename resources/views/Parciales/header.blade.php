<nav id="header" class="p-3">
    <div>
        <a href={{route('Index')}}><img src={{ asset('storage/imagenes/Logos/INICIO-AGENDA-300x127.png')}}
                class="imagenAgenda "></a>
    </div>
    @if (Str::contains(url()->full(),route('panel'))||Str::contains(url()->full(),route('Administracion')))
    <div class="container-fluid text-center d-none d-lg-block d-xl-block ">
