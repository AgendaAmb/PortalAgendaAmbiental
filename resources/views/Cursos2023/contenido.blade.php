...
<div class="row justify-content-center justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-between">
    <div class="col-3 ">
        <a href="https://ambiental.uaslp.mx/imarec/docs/CA/Curso_DRE.pdf"><img src="{{asset('storage/imagenes/Cursos/Curso_DRE.png')}}" class="img-fluid" alt="" srcset=""></a>
    </div>
    <div class="col-3 ">
        <a href="https://ambiental.uaslp.mx/imarec/docs/CA/Curso_EUP.pdf"><img src="{{asset('storage/imagenes/Cursos/Curso_EUP.png')}}" class="img-fluid" alt="" srcset=""></a>
    </div>
    <div class="col-3 ">
        <a href="https://ambiental.uaslp.mx/imarec/docs/CA/Curso_GP.pdf"><img src="{{asset('storage/imagenes/Cursos/Curso_GP.png')}}" class="img-fluid" alt="" srcset=""></a>
    </div>
    <div class="col-3 ">
        <a href="https://ambiental.uaslp.mx/imarec/docs/CA/Curso_CA.pdf"><img src="{{asset('storage/imagenes/Cursos/Curso_CA.png')}}" class="img-fluid" alt="" srcset=""></a>
    </div>
</div>
