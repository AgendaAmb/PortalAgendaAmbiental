...
<div class="col-xl-4 col-lg-4 col-md-4 justify-content-center my-1 pt-0">
    <img src="{{ asset('storage/imagenes/Logos/Ba_Conferencias.png') }}"
...
<div class="col-xl-8 col-lg-8 col-md-8">
    <p class="text-justify pSize pt-5 pt-xl-4 pt-lg-3  pt-md-0">
        Desde el mes de diciembre se detectó el surgimiento de una nueva enfermedad que, a partir de marzo cambió la
        dinámica mundial a raíz de la declaratoria de Pandemia por la Organización Mundial de Salud. La contingencia
        global puso de relieve las profundas desigualdades entre países y entre regiones al interior de los
        países.<br><br> A cinco años del surgimiento de los objetivos de Desarrollo Sostenible, se han consolidado como
        ejes articuladores del cambio urgente en las esferas social, económica, política y ambiental.<br><br>En muchos
        países se han adoptado medidas para cuidar a la población, cubrir los retos educativos, reactivar las economías,
        reformar los sistemas de salud, replantear la movilidad y el turismo para hacer frente a los retos que
        representa una nueva normalidad, un regreso que nos invita a pensar ¿A qué queremos regresar? ¿qué deberíamos
        normalizar y qué no deberíamos permitir en ésta coyuntura?.<br><br>Para responder a ésta y otras preguntas desde
        la sostenibilidad, contamos con la participación de expertos locales, nacionales e internacionales en un ciclo
        de conferencias a distancia, en las cuales se abordaron los retos y las problemáticas de educación, salud
        mental, género y cultura desde una perspectiva de sostenibilidad.
</div>
@endsection
