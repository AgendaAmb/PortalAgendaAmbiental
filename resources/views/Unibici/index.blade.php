...
<div class="row justify-content-between p-xl-5 p-lg-5 p-md-4 p-sm-3 p-3">
  ...
  <div class="row justify-content-around justify-content-xl-between justify-content-lg-between justify-content-md-between justify-content-sm-between">
    <div class="col-12 ">
  ...
  <div class="pSize " class="p-5">
    ...
    <p class="pSize">Fomentar, incentivar y difundir el uso de la bicicleta como insignia para obtener una Movilidad
      Urbana Sostenible
      a través de la mejora de las condiciones físicas, de seguridad y culturales; a través de actividades como paseos,
    ...
    <ul>
      ...
      <li>Fomentar el ciclismo deportivo y el cicloturismo como medios para obtener salud y bienestar así como para
        impulsar el ecoturismo y la cultura.</li>
      <li>Promover la Movilidad Urbana Sostenible desde todos los enfoques de sus actores empezando por los derechos del
        Peatón.</li>
      <li>Colaborar, vincular e incidir en la creación y mejoramiento de la ciudad con respecto a todos los aspectos del
        espacio público con un enfoque participativo.</li>
    </ul><br>
    <h3 class="h3Title">Descripción</h3>
    <p style="text-align: justify;">Unibici es un programa institucional que existe desde el 2012 a partir de la primera
      celebración de la semana de movilidad urbana sustentable, a partir de esa fecha ha evolucionado a hacer de la
      bicicleta una insignia para la movilidad urbana sostenible y todos los medios que se necesitan para
      esto.<br><br>Desde entonces ha incluido cada vez más actividades y eventos, desde talleres de urbanismo táctico,
      cursos, talleres, conferencias, foros, exhibiciones, estrategias y concursos; un ejemplo de esto son las
      Unirodadas de las que ha habido más de 15 y que se dividen en urbanas y ciclo turísticas.<br><br>Unibici incluye
      los ODS 11 Ciudades y comunidades sostenibles, ODS13: Acción por el clima, ODS3: Salud y bienestar y ODS17:
      Alianzas para lograr objetivos. Además, se tiene como marco teórico y normativo la Ley de asentamientos humanos,
      los Derechos a la movilidad y a la vivienda, la Carta de derechos a la ciudad, la Ley de tránsito del estado de
      SLP, Ley de participación de obra pública entre otros.<br><br>Es muy importante la vinculación y crear conexiones
      para sumar y contribuir localmente e internacionalmente por lo que tiene una colaboración interna con el programa
      Unisalud de Servicios Estudiantiles de la UASLP, se forma parte de Bicired un colectivo ciclista nacional, Liga
      Peatonal un colectivo peatonal nacional, la Estrategia Misión Cero y colabora con los colectivos locales para
    ...
    <p style="font-size: 14px !important;"><b>Sistema de Gestión Ambiental</b><br>Agenda Ambiental de la
      UASLP<br>Universidad Autónoma de San Luis Potosí<br>Manuel Nava No. 201, segundo piso<br>Zona Universitaria, C.P.
    ...
    <div class="modal-content">
      ...
      <div class="modal-body py-0">
        ...
        <div class="container">
          ...
          <div class="row justify-content-center justify-content-sm-end justify-content-md-end justify-content-lg-end justify-content-xl-end mx-5 mt-2">
           
            <div class="col-6 col-3 col-xl-3 col-lg-3 col-md-5 col-sm-5 ">
          ...
          <div class="row justify-content-center">
            <div class="col-10" style="color:white; font-size:14px; padding-top: 3%; font-family: 'Myraid light';'">
              <br><br>
              <h4>Unirodada del día del niño 2021
              </h4><br><br>
              <div class="elementor-text-editor elementor-clearfix">
                <div style="font-size: 14px; font-family: 'Myraid light';">
                  <p align="center">El programa Unibici de la Agenda Ambiental en colaboración con la Facultad de
                    Contaduría y Administración, Unisalud y Deportes de Servicios Estudiantiles de la UASLP invitan a
                    la:</p>
                  ...
                  <p>Niñas y niños de todas las edades, comunidad universitaria y público en general</p><br>
                  <h3 style="color: #5c94d7;">Punto de salida mayores de 15 años:</h3>
                  <p>Canchas de la Facultad de Contaduría y Administración (17:00 horas) (8 km)</p><br>
                  ...
                  <p>Promover la movilidad urbana sostenible, la implementación de ciudades incluyentes, sanas y
                    seguras, la divulgación de las ciclovías de nuestra ciudad y la promoción del correcto uso de la
                    bicicleta como medio de transporte.</p>
                  <br>
                  <p align="center">EVENTO SIN COSTO<br><br>No olvides llevar agua, casco y bicicleta en buen estado.
                  </p>
                  <br>
                  <p>Contaremos con medidas Covid, apoyo de Protección Civil Universitaria, policía vial municipal,
                    ambulancia, camioneta de arrastre, bloquedores y protocolo de niños ciclistas.<br><br>Unisalud de
                    Servicios Estudiantiles ofrecerá evaluaciones físicas (peso, talla, masa muscular, masa grasa, % de
                    agua, presión arterial, prueba rápida de glucosa) con su Unidad Médica Móvil.<br><br>Primeros 20
                    inscritos obtendrán un viaje de cortesía para la Unirodada de parte de empresa de bicis de renta
                    YOY.</p><br>
                  ...
                  <ol>
                    <li>Inscríbete llenando el formato de registro en línea que se encuentra como botón en esta página.
                    </li>
                    <li>En 24 horas te llegara un correo con detalles de la unirodada y respecto al uso de bicicletas
