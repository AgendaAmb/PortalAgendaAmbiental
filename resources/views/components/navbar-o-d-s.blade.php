<div class="containe " id="odsHeader">
    <div class="row no-gutters  ml-md-0 ml-sm-0 ml-3">
        ...
        <div @if (route('Gestion')==url()->full()||route('Educacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full())
            class="col mb-1 mt-1"@else class="col mb-2 mt-3 odsDNone"@endif
        >
            <a href="https://www.un.org/sustainabledevelopment/es/health/">
                <img src={{ asset('storage/imagenes/ods/Iconos/ODS3_Salud_Bienestar.png')}} {{route('Gestion')==url()->full()||route('Educacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full()?"id=od3":"class=imgODS"}}>
            </a>
        </div>
    ...
    <div class="row no-gutters  ml-md-0 ml-sm-0">
        ...
        <div  @if (route('Gestion')==url()->full() ||route('Educacion')==url()->full()|| route('Vinculacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full())
            class="col mb-1 mt-1"@else class="col mb-2 mt-3 odsDNone"@endif
        >
            <a href="https://www.un.org/sustainabledevelopment/es/cities/">
                <img src={{ asset('storage/imagenes/ods/Iconos/ODS11_Ciudades.png')}} {{route('Gestion')==url()->full()||route('Educacion')==url()->full()|| route('Vinculacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full()?"id=od3":"class=imgODS"}}>
            </a>
        </div>
        <div  @if (route('Gestion')==url()->full()|| route('Vinculacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full())
            class="col mb-1 mt-1"@else class="col mb-2 mt-3 odsDNone"@endif
        >
            <a href="https://www.un.org/sustainabledevelopment/es/sustainable-consumption-production/">
                <img src={{ asset('storage/imagenes/ods/Iconos/ODS12_Produccion.png')}} {{route('Gestion')==url()->full()|| route('Vinculacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full()?"id=od3":"class=imgODS"}}>
            </a>
        </div>
