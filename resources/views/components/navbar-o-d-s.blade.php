    ...
    <div class="row no-gutters  ml-md-0 ml-sm-0 ml-3">
        ...
        >
            <a href="https://www.un.org/sustainabledevelopment/es/health/">
                <img src={{ asset('storage/imagenes/ods/Iconos/ODS3_Salud_Bienestar.png')}} {{route('Gestion')==url()->full()||route('Educacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full() ||route('Cineminuto')==url()->full()||route('DateUnRespiro')==url()->full()
    ...
    <div class="row no-gutters  ml-md-0 ml-sm-0">
        ...
        >
            <a href="https://www.un.org/sustainabledevelopment/es/cities/">
                <img src={{ asset('storage/imagenes/ods/Iconos/ODS11_Ciudades.png')}} {{route('Gestion')==url()->full()||route('Educacion')==url()->full()|| route('Vinculacion')==url()->full()||route('Unibici')==url()->full()||route('Unihuerto')==url()->full() ||route('Cineminuto')==url()->full()||route('DateUnRespiro')==url()->full()
                ||route('FotografiaS')==url()->full()?"id=od3":"class=imgODS"}}>
            </a>
        </div>
