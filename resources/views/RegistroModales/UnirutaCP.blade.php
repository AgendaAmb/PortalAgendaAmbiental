<div class="modal fade" id="unirutacp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary" id="modalGemas">
        <h5 class="modal-title mx-auto text-white">UNIRUTA CERRO DE SAN PEDRO</h5>
      ...
      <div class="modal-body bg-white" v-if="!InscritoUnirutaCp">
...
{{-- 
          ...
          <hr>
          <h4 class="modal-title3 text-left">Datos de uniruta</h4>
