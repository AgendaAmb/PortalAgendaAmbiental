<div class="modal fade" id="promotores" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary" id="modalGemas">
          <h5 class="modal-title mx-auto text-white">PROMOTORES AMBIENTALES JUVENILES</h5>
        ...
        <div class="modal-body bg-white" v-if="!InscritoPromotores">
