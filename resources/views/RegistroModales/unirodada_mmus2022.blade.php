<div class="modal fade" id="unirodada_mmus2022" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary" id="modalGemas">
        <h5 class="modal-title mx-auto text-white">UNIRODADA MMUS2022</h5>
      ...
      <div class="modal-body bg-white" v-if="!InscritoUnirodadaMmus2022">
        <form @submit.prevent="uaslpUser()">
          ...
          <hr>
          <h4 class="modal-title3 text-center">Datos de Unirodada</h4>
