<div class="modal fade" id="contexto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-primary" id="modalGemas">
        <h5 class="modal-title text-white">Registro Foro "Presa San José"</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body bg-white" v-if="!InscritoCompetencias">
      ...
      <div class="modal-body d-flex justify-content-center bg-white" v-else>
          <div>Ya se encuentra registrado, lo esperamos en el Auditorio Centro de Emprendimiento e Innovación Potosino.</div>
      </div>
    </div>
  </div>
</div>