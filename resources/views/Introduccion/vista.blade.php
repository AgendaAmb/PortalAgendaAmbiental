...
<div class="mt-3 row justify-content-center">
          ...
          <div class="d-block">
            <div class="slide-box">
              <a href={{route('ConsumoResponsable',['nombreModal'=> 'CartelEspacioConsumo'])}}>
                <img src="{{ asset('/storage/imagenes/ConsumoResponsable/B_ECR_Ago2023.png')}}" class="imgCaoursel " alt="First slide">
              </a>
              <a href={{route('ConsumoResponsable',['nombreModal'=> 'CartelEspacioConsumo'])}}>
          ...
          <div class="d-block">
            <div class="slide-box">
              <a href="https://greenmetric.ui.ac.id/rankings/overall-rankings-2021">
                <img src="{{ asset('/storage/imagenes/GreenMetric/GM1.png')}}" class="imgCaoursel " alt="First slide">
              </a>
              <a href="https://greenmetric.ui.ac.id/rankings/overall-rankings-2021">
                <img src="{{ asset('/storage/imagenes/GreenMetric/GM2.png')}}" class="imgCaoursel " alt="First slide">
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="d-block">
            <div class="slide-box">
              <a href={{route('Gestion',['nombreModal'=> 'pdf'])}}>
                <img src="{{asset('/storage/imagenes/PUR/Banner1.png')}}" class="imgCaoursel " alt="First slide">
              </a>
              <a href={{route('Gestion',['nombreModal'=> 'pdf'])}}>
                <img src="{{asset('/storage/imagenes/PUR/Banner2.png')}}" class="imgCaoursel " alt="First slide">
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="d-block">
            <div class="slide-box">
              <a href="{{route('DateUnRespiro')}}">
                ...
                <img src="{{ asset('/storage/imagenes/DateUnRespiro/BannerDateRespiro1.png')}}" class="imgCaoursel " alt="First slide">
              </a>
              <a href="{{route('DateUnRespiro')}}">
                <img src="{{ asset('/storage/imagenes/DateUnRespiro/BannerDateRespiro2.png')}}" class="imgCaoursel " alt="First slide">
              </a>
            </div>
          </div>
        </div>
  ...
  <div id="carouselResponse" class="carousel slide d-block d-xl-none d-lg-none d-md-block d-sm-none px-0" data-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="slide-box">
          <a href="http://wp.uaslp.mx/centenario/">
            <img src="{{ asset('/storage/imagenes/introduccion/UASLP100_1.png')}}" class="imgCaoursel w-100 p-0 p-0" alt="First slide">
          </a>
        </div>
      </div>
      ...
      <div class="carousel-item ">
        <div class="slide-box">
          <a href={{route('ConsumoResponsable',['nombreModal'=> 'CartelEspacioConsumo'])}}>
            <img src="{{ asset('storage/imagenes/ConsumoResponsable/B_ECR_Ago2023.png')}}" class="imgCaoursel w-100 p-0 p-0 " alt="First slide">
          </a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="slide-box">
          <a href="https://greenmetric.ui.ac.id/rankings/overall-rankings-2021">
            <img src="{{ asset('/storage/imagenes/GreenMetric/GM1.png')}}" class="imgCaoursel w-100 p-0 p-0" alt="First slide">
          </a>
        </div>
      </div>
      <div class="carousel-item">
        <div class="slide-box">
          <a href={{route('Gestion',['nombreModal'=> 'pdf'])}}>
            <img src="{{ asset('storage/imagenes/PUR/Banner1.png')}}" class="imgCaoursel w-100 p-0 p-0 " alt="First slide">
          </a>
        </div>
      </div>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-10 col-xl-10 col-lg-10 col-md-10 col-sm-10 ">
                <img src="{{asset('storage/imagenes/CompetenciasProf/Cartel_CP.png')}}" class="img-fluid" alt="">
              </div>
            </div>
            <br>
            <div class="row justify-content-center">
              <a href="{{asset('storage/imagenes/CompetenciasProf/Cartel_CP.png')}}" class="btn btn-secondary bg-light text-muted downloadBtn mx-1" href="#" role="button" download="CartelCompetenciasProfesionales.png">
                DESCARGAR CARTEL
              </a>
              <a class="btn btn-secondary bg-light text-muted downloadBtn mx-1" href={{route('Bienvenida',['nombreModal'=> 'contexto'])}} role="button">
                REGISTRAR
              </a>
            </div>
          </div>
  ...
  <div class="mt-3 row justify-content-between  Ejes d-none d-xl-flex d-lg-flex d-md-flex">
    <div class="col-md-7 pl-5 ">
      <div class="envoltorioCirculoODS">
        <img src="storage/imagenes/ods/circulo-UASLP-SOCIEDAD.webp" class="img-fluid" width="518" id="circuloODS" usemap="#circuloODS">
        ...
        <a href="http://www.uaslp.mx">
          <img class="img-fluid" src="storage/imagenes/ods/circulo-UASLP-SOCIEDAD-e1587668903442.webp" id="circuloUaslp" width="228">
        </a>
  ...
  <div class="modal fade" id="Concurso17gemas" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg  modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body py-0">
          ...
          <div class="container-fluid">
            ...
            <div class="row justify-content-start justify-content-sm-between justify-content-md-between justify-content-lg-between justify-content-xl-between mx-xl-5 mx-2 mt-2">
              <div class=" col-4 col-xl-4 col-lg-3 col-md-6 col-sm-6  px-0 px-xl-3">
                <a href="{{route('login')}}" class="btn btn-secondary bg-light  text-muted  " id="botones" role="button" id="botones">REGISTRO</a>
              </div>
              <div class=" col-4 col-xl-4 col-lg-3 col-md-6 col-sm-6  ">
                <a href="{{asset('storage/imagenes/17Gemas/Bases17gemas.pdf')}}" class="btn btn-secondary bg-light  text-muted  " href="#" role="button" id="botones" download="Bases17gemas.pdf">BASES </a>
              </div>
              ...
              <div class="row justify-content-center">
                <div class="col-10" style="color:white; font-size:15px; padding-top: 3%; font-family: 'Myraid light';' ">
                  ...
                  <p style="font-size: 15px;" class="text-justify">Para mayor información consulta las <a href="{{asset('storage/imagenes/17Gemas/Bases17gemas.pdf')}}" download="Bases17gemas.pdf">bases.</a></p>
