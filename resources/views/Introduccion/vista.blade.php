        ...
        <div class="carousel-item" data-interval="4000">
          <div class="d-block">
            <div class="slide-box">
              ...
              <a href="{{route('Educacion',['nombreModal'=> 'ConcursoFotografia'])}}">
                <img src="{{asset('/storage/imagenes/ConcursoFotografia/B_ConFoto2.png')}}" class="imgCaoursel "
                  alt="First slide">
              </a>
            </div>
          </div>
          ...
          <div class="d-block">
            <div class="slide-box">
              <a href={{route('ConsumoResponsable',['nombreModal'=> 'CartelEspacioConsumo'])}}>
                <img src="{{ asset('/storage/imagenes/ConsumoResponsable/B_ECR_Jun2023.png')}}" class="imgCaoursel "
                  alt="First slide">
              </a>
              <a href={{route('ConsumoResponsable',['nombreModal'=> 'CartelEspacioConsumo'])}}>
    ...
    <div id="carouselResponse" class="carousel slide d-block d-xl-none d-lg-none d-md-block d-sm-none px-0" data-ride="carousel">
      <div class="carousel-inner">
        ...
        <div class="carousel-item ">
          <div class="slide-box">
            <a href={{route('ConsumoResponsable',['nombreModal'=> 'CartelEspacioConsumo'])}}>
              <img src="{{ asset('storage/imagenes/ConsumoResponsable/B_ECR_Jun2023.png')}}"
                class="imgCaoursel w-100 p-0 p-0 " alt="First slide">
            </a>
          </div>
        </div>
